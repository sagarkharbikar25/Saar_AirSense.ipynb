...
**Student Name:** Sagar  
**Internship Program:** AICTE | IBM SkillsBuild Data Analytics with AI Academic Internship Program 2026  
**Partner Organization:** BharatCares in association with AICTE  
...
- **Code File:** `Sagar_AirSense.ipynb` (clean, fully executed end-to-end data pipeline & ML model)
- **Requirements File:** `requirements.txt` (Python libraries required to reproduce the notebook)
- **Project Report:** `Sagar_ProjectReport.docx` (complete Microsoft Word documentation with visual charts)
- **README File:** `README.md` (project overview, dataset link, description, and run instructions)
